...
export default function List() {
    const [currentPage, setCurrentpage] = useState(0)
      ...
      const {data, isLoading} = useGetCodesList(currentPage, 10, 'exclusive',rarity, itemfilter, status,search)
  ...
  return (
    <div className=' w-full flex flex-col text-sm bg-yellow-50 border-[1px] border-zinc-100 rounded-md p-8'>
        <p className=' text-lg font-semibold text-orange-500'>Exclusive Item Claim History</p>
