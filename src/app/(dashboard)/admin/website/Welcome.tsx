...
export default function Welcome() {
  ...
  const onSubmit = () => {
    if(imageFile === null){
        ...
        createMinigame({image: imageFile, section: 'welcome'},{
            onSuccess: () => {
  ...
  return (
    <div className=' w-full flex flex-col text-sm bg-yellow-50 border-[1px] border-zinc-100 rounded-md p-8'>
        <h2 className=' text-lg font-bold'>CalCheese Worlds</h2>
      ...
      <DialogContent className="p-6 bg-yellow-50">
        <DialogHeader>
          <DialogTitle>Upload CalCheese World Thumbnail</DialogTitle>
        ...
        <div className=' w-full grid grid-cols-2 md:rid-cols-3 gap-4 mt-8'>
            {data?.data.map((item, index) => (
                <div key={item.id} className=' w-full aspect-video flex items-center justify-center bg-white relative'>
                    ...
                    <DialogContent className="p-6 bg-yellow-50">
                        <DialogHeader>
                        <DialogTitle>Delete CalCheese World Thumbnail</DialogTitle>
                    ...
                    <DialogContent className="p-6 bg-yellow-50">
                        <DialogHeader>
                        <DialogTitle>Edit CalCheese World Thumbnail</DialogTitle>
